...
- **[TAMU AI Chat](/guides/tamu-ai-chat)** — Guided preview/production setup for Texas A&M's OpenAI-compatible endpoint, live `protected.*` model discovery, context metadata, and local per-model usage reporting.
