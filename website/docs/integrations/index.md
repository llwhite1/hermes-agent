...
- **[TAMU AI Chat](/guides/tamu-ai-chat)** — Guided Standard/Preview setup for Texas A&M's OpenAI-compatible endpoints, live `protected.*` discovery, Preview image generation, model-specific limits, and local per-model usage.
